...
My partner's autoscrape code works in scraping and crawling the enforcement action details from January 2021 onward. It has 2,998 rows based on the title, date, category, link, and agency name for each enforcement action. 
